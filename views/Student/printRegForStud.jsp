                            ...
                            <% 
                               ...
                               Courses course;
                                for(Object courseReg:list) 
                                {
                                    ...
                                    course=CourseCon.getCourseObject(coursereg.getCou_code());

                            %>
                            <tr>
                                <td><%=coursereg.getCou_code()%></td> 
                ...
                <div class="row">
                    ...
                    <div class="col-lg-10">
                        <table border="1" text-align="center">
                            ...
                            <% 
                               List list=StudCon.getExRegCourse((String)session.getAttribute("stud_uname"),stud.getTerm(),new Integer(stud.getYear()));
                               
                               Courses course;
                                for(Object obj:list) 
                                {
                                    Exam_reg exreg=(Exam_reg)obj;
                                    course=CourseCon.getCourseObject(exreg.getCou_code());
                            %> 
                            <tr> 
                                <td><%=cnt++%></td>
                                <td><%=exreg.getCou_code()%></td> 
                                <td><%=(course.getCourse_name()).toUpperCase()%></td> 
                                <td><%if(course.getCou_th_min()>0)out.print("Y"); else out.print("X"); %></td>  
                                <td><%if(course.getCou_pt_min()>0)out.print("Y"); else out.print("X"); %></td>  
                                <td><%if(course.getCou_pr_min()>0)out.print("Y"); else out.print("X"); %></td>  
                                <td><%if(course.getCou_tw_min()>0)out.print("Y"); else out.print("X"); %></td>  
                                <td><%if(course.getCou_or_min()>0)out.print("Y"); else out.print("X"); %></td>
                                <td><%if(course.getYear()==stud.getYear()&&course.getTerm().equals(stud.getTerm())){out.print("X");}else{out.print("Y");}%></td> 
                            </tr>
                            <%
                                } 
                            %>
