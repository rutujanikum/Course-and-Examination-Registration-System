...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row"><div class="col-lg-8"> <p class="alert alert-success"><a href="#" class="close" data-dismiss="alert">&times;</a><%=request.getParameter("failResult")%></p></div></div>
            <%}
                }catch(Exception e){}
       ...
       <form action="../../Controller/hodReg.jsp" method="post"> 
            First name: <input type="text" name="fname"  pattern="[A-Za-z]{1,50}" required oninvalid="this.setCustomValidity('First name should be contain one upper casr or one lower case letter.')"
