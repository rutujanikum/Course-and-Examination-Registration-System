...
<html>
    <head>
        ...
        <title>collage Reg Report</title>
   ...
   <table border="2" class="table" align="center">
      ...
      <%
         ...
         int cnt=1;
            ...
            s=sf.openSession();
            try{
            String branch[]={"CM","IF","ME","IDD","DDGM","PL","EL","EE","CE","AE"};
           ...
           String  fresult[][]=new String [3][3];
            ...
            for(int j=0;j<branch.length;j++)
            {
                for(int i=1;i<=3;i++)
                {
                    Query query = s.createQuery("SELECT regno FROM Course_reg WHERE program =:branch and year =:year "+" GROUP BY regno");
                    ...
                    <tr>
                        <td> <%=cnt++%></td>
                        <td><%= branchNames[j] %></td>            
                <td align="right" ><% out.println(list1.size());%></td> 
                 <td align="right" ><% out.println(list2.size());%></td> 
                    <td align="right" ><% out.println(list3.size());%></td> 
